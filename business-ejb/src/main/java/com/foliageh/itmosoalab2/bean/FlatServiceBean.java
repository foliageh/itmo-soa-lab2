...
import com.foliageh.itmosoalab2.remote.FlatServiceRemote;
...
@Stateless
public class FlatServiceBean implements FlatServiceRemote {

    @Inject
    private FlatRepository repository;

    @EJB
    private AsyncTaskServiceRemote asyncTaskService;
